...
if(!isset($_SESSION['loggedin']) && $_SESSION['loggedin']!=true){
  header("location.href='signinpage.php'");
} 
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
  <div class="product-box">
    <img src="pic/Product-1.jpeg" alt="Product Image" class="product-image">
  </div>
  ...
  <a href="toCheckout.php" id="proceedButtonLink"> <button class="proceed-button">Proceed to Payment</button> </a>
  <a href="bakery.php" id="proceedButtonLink"> <button class="proceed-button1">Back to website</button> </a>
</div>
...
<script>
  ...
  function calculateGrandTotal() {
    ...
    document.getElementById('proceedButtonLink').href = `toCheckout.php?quantity=${quantity}`;
  }
